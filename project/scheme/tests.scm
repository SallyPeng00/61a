...
(eval (define two_pi (* 2 3.14)))
;expect 6.28

(define a (cons 1 (cons 3 nil)))
;expect a

(begin (define x 3) (+ 1 2) '(+ 1 2))
;expect (+ 1 2)
...
; ((define-macro (f-233 g n) `(if ,g ,(- n 1) 233)))
; ;expect f-233
...
(define (enumerate s)
  ...
  (define (helper lst index)
    (cond
      ((null? lst) nil)
      (else (cons (cons index (cons (car lst) nil)) (helper (cdr lst) (+ 1 index))))
      ))
  (helper s 0))
