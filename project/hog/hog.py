...
def is_swap(player_score, opponent_score):
    ...
    if player_score % 10 == opponent_score % 10:
        return True
    elif p_tens == o_tens and p_tens != 0:
        return True
    else:
        return False
    # END PROBLEM 4
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def announce(score0, score1):
        ...
        return announce_highest(who, p_high, previous_score + increase)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    """
    # BEGIN PROBLEM 9
    counter, max_roll, k = 10, 1, 0
    while counter > 0:
        averaged_dice = make_averaged(roll_dice, num_samples)
        curr_roll = averaged_dice(counter, dice)
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    if is_swap(new_score, opponent_score) and opponent_score > new_score:
        return 0
    elif free_bacon(opponent_score) >= margin and (not is_swap(new_score, opponent_score) or new_score <= opponent_score):
        return 0
